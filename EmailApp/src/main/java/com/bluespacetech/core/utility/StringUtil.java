...
public final class StringUtil
{
    ...
    /** The Constant TOKEN_XHDR_BEGIN. */
    public final static String TOKEN_XHDR_BEGIN = "10.";
    
    /** The Constant TOKEN_XHDR_END. */
    ...
    /**
     * convert Address array to a string, addresses are comma delimited. Display names are removed from returned addresses.
     * 
     ...
     * 
     * @param addrs - Address array
     * @param removeDisplayName - remove display name from addresses if true
     * @return a string of addresses, comma delimited. or null if input is null
     */
    ...
    /**
     * remove display name from an email address, and convert all characters to lower case.
     * 
     ...
     * 
     * @param addr - email address
     * @param toLowerCase - true to convert characters to lower case
     * @return email address without display name, or null if input is null.
     */
     ...
     * 
     * @param addr - email address
     * @return - display name of the address, or null if the email address does not have a display name.
     */
    ...
    /**
     * Compare two email addresses. Email address could be enclosed by angle brackets and it should still be equal to the one without angle brackets.
     * 
     * @param addr1 - email address 1
     * @param addr2 - email address 2
    ...
    /**
     * For String objects found in the bean class with a getter and a setter, this method will strip off the leading and trailing spaces of those string objects.
     * 
     * @param obj - a bean object
     */
     ...
     * @param replFrom - from string
     * @param replWith - with string
     * @return new string
     */
     ...
     * @param removeLast the remove last
     * @return the string
     */
     ...
     * 
     * @param level - number periods to be returned
    ...
    /**
     * Check if the provided string is a valid email address. This conforms to the RFC822 and RFC1035 specifications. Both local part and remote part are required.
     * 
    ...
    /**
     * Check if the provided string is a valid remote or Intranet email address. An Intranet email address could include only a sub-domain name such as "bounce" or "localhost" as its remote part.
     * 
     * @param string The string to be checked.
     * @return True if string is an valid email address. False if not.
     */
    ...
    /**
     * matches any remote or local email addresses like john (without a remote part) or john@localhost or john@smith.com.
     * 
    ...
    /**
     * Checks if is valid email local part.
     *
     * @param string the string
     * @return true, if is valid email local part
     */
    ...
    /**
     * Checks if is VERP address.
     *
     * @param recipient the recipient
     * @return true, if is VERP address
     */
    ...
    /**
     * Gets the dest addr from VERP.
     *
     * @param verpAddr the verp addr
     * @return the dest addr from VERP
     */
    ...
    /**
     * Gets the orig addr from VERP.
     *
     * @param verpAddr the verp addr
     * @return the orig addr from VERP
     */
